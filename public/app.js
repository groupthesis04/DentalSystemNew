...
async function api(path, options = {}) {
  if (window.location.protocol === "file:") {
    throw new Error("Open the app through the Python server, not by double-clicking index.html. Run python server.py --port 8000, then visit http://127.0.0.1:8000.");
  }
