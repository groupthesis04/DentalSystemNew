...
def main() -> None:
    ...
    try:
        ...
        doctor_name = doctor_registration["user"]["name"]
        ...
        status, availability_created = request(
            doctor,
            base_url,
            "/api/availability",
            "POST",
        ...
        availability_ids.add(availability_created["availability"]["id"])
        ...
        cleanup(emails, availability_ids)
